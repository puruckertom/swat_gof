...
ts.filename <- paste(sf_dir,"ts.pdf",sep="")
...
# plot the pdfs
par(mfrow=c(1,1))
pdfs.filename <- paste(sf_dir,"hist_pdfs.pdf",sep="")
...
# periodograms
per.filename <- paste(sf_dir,"periodograms.pdf",sep="")
...
per.filename <- paste(sf_dir,"periodograms_month.pdf",sep="")
pdf(file=per.filename,width=8.5, height=10.5, bg="white")
  par(mfrow=c(2,1))
...
per.filename <- paste(sf_dir,"periodograms_week.pdf",sep="")
pdf(file=per.filename,width=8.5, height=10.5, bg="white")
  par(mfrow=c(2,1))
...
# periodograms shortened to a week
per.filename <- paste(sf_dir,"periodograms_shorterweek.pdf",sep="")
pdf(file=per.filename,width=8.5, height=10.5, bg="white")
  par(mfrow=c(2,1))
