...
dir.best.mc.ncdc <- paste(source_dir,"mcCL_NCDC/mcNCDCd3/",sep="")
dir.best.lr.ncdc <- paste(source_dir,"lrCL_NCDC/lrNCDCd4/",sep="")
dir.best.nc.ncdc <- paste(source_dir,"ncCL_NCDC/ncNCDCd3/",sep="")
dir.best.fb.ncdc <- paste(source_dir,"fbCL_NCDC/fbNCDCd4/",sep="")

dir.best.mc.mpe <- paste(source_dir,"mcCL_MPE/mcMPEd2/",sep="")
dir.best.lr.mpe <- paste(source_dir,"lrCL_MPE/lrMPEd2/",sep="")
dir.best.nc.mpe <- paste(source_dir,"ncCL_MPE/ncMPEd5/",sep="")
dir.best.fb.mpe <- paste(source_dir,"fbCL_MPE/fbMPEd5/",sep="")

best.dirs <- vector(mode="character",length=8)
best.dirs[1] <- dir.best.mc.ncdc
best.dirs[2] <- dir.best.lr.ncdc
best.dirs[3] <- dir.best.nc.ncdc
best.dirs[4] <- dir.best.fb.ncdc
best.dirs[5] <- dir.best.mc.mpe
best.dirs[6] <- dir.best.lr.mpe
best.dirs[7] <- dir.best.nc.mpe
best.dirs[8] <- dir.best.fb.mpe
...
dir.val.mc.ncdc <- paste(source_dir,"mcCL_NCDCV/",sep="")
dir.val.lr.ncdc <- paste(source_dir,"lrCL_NCDCV/",sep="")
dir.val.nc.ncdc <- paste(source_dir,"ncCL_NCDCV/",sep="")
dir.val.fb.ncdc <- paste(source_dir,"fbCL_NCDCV/",sep="")
dir.val.mc.mpe <- paste(source_dir,"mcCL_MPEV/",sep="")
dir.val.lr.mpe <- paste(source_dir,"lrCL_MPEV/",sep="")
dir.val.nc.mpe <- paste(source_dir,"ncCL_MPEV/",sep="")
dir.val.fb.mpe <- paste(source_dir,"fbCL_MPEV/",sep="")

val.dirs <- vector(mode="character",length=8)
val.dirs[1] <- dir.val.mc.ncdc
val.dirs[2] <- dir.val.lr.ncdc
val.dirs[3] <- dir.val.nc.ncdc
val.dirs[4] <- dir.val.fb.ncdc
val.dirs[5] <- dir.val.mc.mpe
val.dirs[6] <- dir.val.lr.mpe
val.dirs[7] <- dir.val.nc.mpe
val.dirs[8] <- dir.val.fb.mpe
